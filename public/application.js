...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields2 = __webpack_require__(10);
	...
	var fillBoard = function fillBoard(array) {
	  for (var i = 0; i < 9; i++) {
	    if (array[i] === 0) {
	      gameBoard[i] = 5;
	      array[i] = 5;
	...
	var checkWinner = function checkWinner(gameBoard) {
	  var topRow = gameBoard[0] + gameBoard[1] + gameBoard[2];
	  var midRow = gameBoard[3] + gameBoard[4] + gameBoard[5];
	  var bottomRow = gameBoard[6] + gameBoard[7] + gameBoard[8];
	  var leftColumn = gameBoard[0] + gameBoard[3] + gameBoard[6];
	  var midColumn = gameBoard[1] + gameBoard[4] + gameBoard[7];
	  var rightColumn = gameBoard[2] + gameBoard[5] + gameBoard[8];
	  var slash = gameBoard[2] + gameBoard[4] + gameBoard[6];
	  var backSlash = gameBoard[0] + gameBoard[4] + gameBoard[8];
	  if (topRow === 3) {
	    fillBoard(gameBoard);
	  ...
	  if (tieCheck.length === 9) {
	    ...
	    api.patchGame(_forPatch16);
	  }
	};

	var togglePlayer = function togglePlayer(param) {
	  if (param === 1) {
	    activePlayer = 2;
	  } else {
	    activePlayer = 1;
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).then(ui.signUpSuccess).then(function () {
	    api.signInAuto(data).then(ui.autoSignInSuccess).catch(ui.autoSignInFailure);
	...
	var gamePlay0 = function gamePlay0() {
	  if (gameBoard[0] === 0) {
	    if (activePlayer === 1) {
	      $('.zero').text('X');
	      var forPatch = {
	      ...
	      api.patchGame(_forPatch17);
	    }
	  }
	  gamePlay(0);
	};

	var gamePlay1 = function gamePlay1() {
	  if (gameBoard[1] === 0) {
	    if (activePlayer === 1) {
	      $('.one').text('X');
	      var forPatch = {
	      ...
	      api.patchGame(_forPatch18);
	    }
	  }
	  gamePlay(1);
	};

	var gamePlay2 = function gamePlay2() {
	  if (gameBoard[2] === 0) {
	    if (activePlayer === 1) {
	      $('.two').text('X');
	      var forPatch = {
	      ...
	      api.patchGame(_forPatch19);
	    }
	  }
	  gamePlay(2);
	};

	var gamePlay3 = function gamePlay3() {
	  if (gameBoard[3] === 0) {
	    if (activePlayer === 1) {
	      $('.three').text('X');
	      var forPatch = {
	      ...
	      api.patchGame(_forPatch20);
	    }
	  }
	  gamePlay(3);
	};

	var gamePlay4 = function gamePlay4() {
	  if (gameBoard[4] === 0) {
	    if (activePlayer === 1) {
	      $('.four').text('X');
	      var forPatch = {
	      ...
	      api.patchGame(_forPatch21);
	    }
	  }
	  gamePlay(4);
	};

	var gamePlay5 = function gamePlay5() {
	  if (gameBoard[5] === 0) {
	    if (activePlayer === 1) {
	      $('.five').text('X');
	      var forPatch = {
	      ...
	      api.patchGame(_forPatch22);
	    }
	  }
	  gamePlay(5);
	};

	var gamePlay6 = function gamePlay6() {
	  if (gameBoard[6] === 0) {
	    if (activePlayer === 1) {
	      $('.six').text('X');
	      var forPatch = {
	      ...
	      api.patchGame(_forPatch23);
	    }
	  }
	  gamePlay(6);
	};

	var gamePlay7 = function gamePlay7() {
	  if (gameBoard[7] === 0) {
	    if (activePlayer === 1) {
	      $('.seven').text('X');
	      var forPatch = {
	      ...
	      api.patchGame(_forPatch24);
	    }
	  }
	  gamePlay(7);
	};

	var gamePlay8 = function gamePlay8() {
	  if (gameBoard[8] === 0) {
	    if (activePlayer === 1) {
	      $('.eight').text('X');
	      var forPatch = {
	      ...
	      api.patchGame(_forPatch25);
	    }
	  }
	  gamePlay(8);
	};

	var gamePlay = function gamePlay(square) {
	...
	var getStats = function getStats(event) {
	  event.preventDefault();
	  api.getUserGames().then(ui.getUserGamesSuccess).catch(ui.getUserGamesFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields2 = function getFormFields2(form) {
	  var target = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signInAuto = function signInAuto(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/sign-in',
	    method: 'POST',
	    data: data
	...
	var patchGame = function patchGame(forPatch) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var autoSignInFailure = function autoSignInFailure(error) {
	  // console.error(error)
	...
	var getUserGamesSuccess = function getUserGamesSuccess(data) {
	...
	var getUserGamesFailure = function getUserGamesFailure(error) {
	  // console.error(error)
	};
	...
	module.exports = {
	  ...
	  getUserGamesSuccess: getUserGamesSuccess,
	  getUserGamesFailure: getUserGamesFailure,
